...
date: 2017-06-21
---
属于新模式。我们在之前介绍了[23种设计模式](http://blueskykong.com/2017/01/12/designPattern1/)，设计模式诞生多年，设计模式也在逐步增多。本文将会介绍一个常用且容易忽视的模式：空指针模式。
...
![nullable-pattern](https://img2.sycdn.imooc.com/5acf093b0001449604830228.jpg "空指针模式UML图")
...
### 参考
1. 设计模式之禅
2. [被遗忘的设计模式——空对象模式（Null Object Pattern）](https://blog.csdn.net/qiumengchen12/article/details/44923139)
