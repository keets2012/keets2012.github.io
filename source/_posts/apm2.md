...
![mcd](../../../../pic/complextreace.png "微服务调用链")
...
![zipkininfo](../../../../pic/zipkin-info.jpg "zipkin链路调用分析")
zipkin的链路监控粒度相对没有那么细，从上图可以看到调用链中具体到接口级别，再进一步的调用信息并未涉及。

- skywalking

![swinfo](../../../../pic/sw-info.jpg "skywalking链路调用分析")
...
![ppinfo](../../../../pic/pp-info.jpg "pinpoint链路调用分析")
...
![ppreal](../../../../pic/ppreal.jpg "pinpoint链路拓扑")

![skyreal](../../../../pic/skreal.jpg "skywalking链路拓扑")

![zipkinreal](../../../../pic/zipdependency1.jpg "zipkin dependency")
